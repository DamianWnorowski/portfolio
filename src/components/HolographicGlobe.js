...
const STEEL_BLUE = new THREE.Color(0x4a9eff);
const SUCCESS_GREEN = new THREE.Color(0x22c55e);
const DARK_BLUE = new THREE.Color(0x0a1428);
...
export class HolographicGlobe {
    ...
    init() {
        ...
        // Point light
        const pointLight = new THREE.PointLight(0xc9a227, 1, 400);
    ...
    createGlobe() {
        ...
        // Wireframe overlay
        const wireGeo = new THREE.SphereGeometry(60.5, 32, 32);
